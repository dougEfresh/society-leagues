...
join leagues.player home on home.user_id = a.player_id
   and home.season_id=tm.season_id and tm.division_id=home.division_id and home.team_id = a.team_id 
join leagues.player away 
       on away.user_id = b.player_id and away.season_id=tm.season_id
       and tm.division_id=away.division_id and away.team_id = b.team_id 
left join
